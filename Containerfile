...
RUN pacman -Syu --noconfirm base cpio dracut linux-lts linux-firmware ostree btrfs-progs e2fsprogs xfsprogs dosfstools skopeo podman bootc dbus dbus-glib glib2 ostree shadow glibc && pacman -Scc --noconfirm
